  ...
  const experiences = [
    {
      ...
      company: "Dopamine Couch",
      period: "08/2025 - 04/2026",
      description: [
        "Took complete ownership of production and staging environments hosted on VPS using Docker & Docker Compose",
        "Managed NGINX reverse proxy setup, domain routing, and SSL configuration",
        "Deployed and maintained Django backend + static frontend architecture",
        "Handled live production issues, debugging failures, and ensuring system uptime",
        "Designed environment structure for production and staging separation",
        "Performed container management, service monitoring, and deployment updates",
        "Improved system reliability by implementing structured deployment workflow"
      ]
    },
    {
